...
$arr_cel = combinar_celdas($columna, $fila, 0, 3);
$rango = $arr_cel['rango'];
$columna = $arr_cel['columna'];
//echo $rango . " - " . $columna . "<br>";
$objPHPExcel->getActiveSheet()->mergeCells($rango);
...
$objPHPExcel->getActiveSheet()->setCellValue($columna . $fila, "IMU1");
$arr_cel = combinar_celdas($columna, $fila, 0, 0);
$rango = $arr_cel['rango'];
$columna = $arr_cel['columna'];
//echo $rango . " - " . $columna . "<br>";
...
$objPHPExcel->getActiveSheet()->setCellValue($columna . $fila, "Imu 2");
$arr_cel = combinar_celdas($columna, $fila, 0, 0);
$rango = $arr_cel['rango'];
$columna = $arr_cel['columna'];
//echo $rango . " - " . $columna . "<br>";
